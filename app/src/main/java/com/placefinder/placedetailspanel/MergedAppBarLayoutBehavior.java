...
public class MergedAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    private boolean mIsStatusBarVisuble = false;
    ...
    private View mStatusBarReplacer;
...
/*                Window window = ((Activity)mContext).getWindow();
                ...
                mStatusBarReplacer.setBackgroundColor(mContext.getResources().getColor(R.color.colorPrimary));
                mIsStatusBarVisuble = true;
...
/*                Window window = ((Activity)mContext).getWindow();
                ...
                mStatusBarReplacer.setBackgroundColor(mContext.getResources().getColor(android.R.color.transparent));
                mIsStatusBarVisuble = false;


                // MY ADDITION
                //mToolbar.setPadding(0, 80, 0, 0);
            }
        }
    }
